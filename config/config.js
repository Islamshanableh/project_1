...
module.exports = {
  ...
  sendGrid: {
    api_key: envVars.SG_API_KEY,
    sender: envVars.SG_VERIFIED_EMAIL,
    debugEmail: envVars.SG_VERIFIED_EMAIL,
  },
  aws: {
    access_key_id: envVars.AWS_ACCESS_KEY_ID,
    secret_access_key: envVars.AWS_SECRET_ACCESS_KEY,
    bucket_name_catlog: envVars.AWS_BUCKET_NAME_CATLOG,
    bucket_name_upload: envVars.AWS_BUCKET_NAME_UPLOAD,
    region: envVars.AWS_REGION,
    exp_in: envVars.AWS_EXP_IN,
    cloudFrontUserUploadsUrlPrefix: envVars.CF_USER_UPLOADS_URL_PREFIX,
    cloudFrontCatalogUrlPrefix: envVars.CF_CATALOG_URL_PREFIX,
  },
};
